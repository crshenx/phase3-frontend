    ...
    <div className='about'>
        <div className='aboutContainer'>
            ...
            <img className="lauren-pic" src='https://i.imgur.com/Y9lz9It.png' alt="Lauren pic" />
                ...
                <a className="linkedin-icon" href="https://linkedin.com/in/lauren-erxleben" target="_blank">
                <ion-icon name="logo-linkedin"></ion-icon></a>
                <a className="github-icon" href="https://github.com/laurennoelle" target="_blank">
